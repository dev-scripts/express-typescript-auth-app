...
import { expressAuthentication } from './configs/auth.config';
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.post('/auth/register',
            ...
            const args = {
                    req: {"in":"body","name":"req","required":true,"ref":"RegisterRequest"},
            };
        ...
        app.post('/auth/login',
            ...
            const args = {
                    req: {"in":"body","name":"req","required":true,"ref":"LoginRequest"},
            };
